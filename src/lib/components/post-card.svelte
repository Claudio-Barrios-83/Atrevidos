    ...
    <div class="min-w-0 flex-grow">
      ...
      <div class="mt-4 flex flex-wrap items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
        ...
        <button
          ...
          class={`rounded-lg px-2 py-1 font-semibold transition ${isOwnPost ? 'cursor-not-allowed text-gray-400 opacity-70 dark:text-gray-500' : 'text-amber-700 hover:bg-amber-50 hover:text-amber-800 dark:text-amber-300 dark:hover:bg-amber-950/30 dark:hover:text-amber-200'}`}
        >
        ...
        <button
          ...
          class={`rounded-lg px-2 py-1 font-semibold transition ${isOwnPost ? 'cursor-not-allowed text-gray-400 opacity-70 dark:text-gray-500' : 'text-rose-600 hover:bg-rose-50 hover:text-rose-700 dark:text-rose-300 dark:hover:bg-rose-950/30 dark:hover:text-rose-200'}`}
        >
          Reportar
        </button>
      </div>
